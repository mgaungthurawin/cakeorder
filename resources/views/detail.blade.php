        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
                    ...
                    <div class="block3">
                        ...
                        <div class="block3-txt p-t-14">
                            ...
                            <span class="s-text6">Price: {{$product->price}}Ks</span>
                ...
                <div class="col-sm-10 col-md-4 p-b-30 m-l-r-auto">
                    <!-- Block3 -->
                    <div class="block3">
                        <form method="post" action="{{route('cakeorder')}}">
                            ...
                            <textarea class="dis-block s-text7 size20 bo4 p-l-22 p-r-22 p-t-13 m-b-20" name="address" placeholder="Please add your full address"></textarea>
